...
import {CATEGORIES, CATEGORY_RULES} from '../constants/appConstants';
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-6">
            {filteredDashboards.map((db) => (
              <button
                  ...
                  className="group relative flex flex-col text-left bg-slate-800/50 border border-slate-700/70 rounded-[2rem] p-7 hover:border-indigo-400 hover:bg-slate-800/70 transition-all duration-500 backdrop-blur-sm hover:-translate-y-2 shadow-xl hover:shadow-indigo-500/10"
                >
